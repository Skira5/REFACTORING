...
use NebenClassen\Hero;
use NebenClassen\HeroMage;
...
class CreatHero
{
    ...
    private function createHeroByClass($heroName): Hero
    {
        ...
        switch ($heroClass) {
            ...
            case '2':
            case 'Warrior':
                return new \KleineBeispiel\LargeClass\Positive\HeroWarrior($heroName);
            case '3':
            case 'Archer':
                return new \KleineBeispiel\LargeClass\Positive\HeroArcher($heroName);
            default:
